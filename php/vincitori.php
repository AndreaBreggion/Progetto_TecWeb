<?php
    ...
    $replacement = strlen($replacement) == 0 ? '<li><p>I vincitori della categoria Ragazzi non sono ancora stati eletti.</p></li>' : $replacement;
    $page = str_replace('<placeholderRagazzi />', $replacement, $page);
    $replacement = createPresepeListAdulti($connection);
    $replacement = strlen($replacement) == 0 ? '<li><p>I vincitori della categoria Adulti non sono ancora stati eletti.</p></li>' : $replacement;
