<?php
    ...
    $builder = new TemplateBuilder("Vincitori", "..");
    ...
    $page = $builder->build();
    $page = str_replace('<li><a href="../php/vincitori.php">Presepi in Gara</a></li>', '<li class="current" aria-current="page"><span class="currentPage">Vincitori</span></li>', $page);
