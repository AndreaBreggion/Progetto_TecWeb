<?php
  function checkUserConnection() {
    if(isset($_SESSION["uName"]) && $_SESSION["loggedin"]=='admin') {
      ...
      return('<span class="logHint">Benvenuto <a href="<rootDIR></rootDIR>/php/user.php" role="button">' . $_SESSION["uName"] . '</a> ! <a href="<rootDIR></rootDIR>/php/logout.php" role="button"> Effettua il logout </a></span>');
    }
    else {
